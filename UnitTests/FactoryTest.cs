...
namespace UnitTests
{
    ...
    public class FactoryTest
    {
        ...
        public async Task Setup()
        {
            ...
            var transactionHash = await web3.Eth.DeployContract.SendRequestAsync(abi, contractByteCode, addressFrom, new HexBigInteger(900000));
            Assert.NotNull(transactionHash);
        }
